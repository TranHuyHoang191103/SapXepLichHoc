...
import School.com.DAO.AccoutDAO;
...
public class DangNhap extends javax.swing.JFrame {
    ...
    private void btnDangNhapActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDangNhapActionPerformed
       try {
            ...
            String matKhau = new String(txtmatkhau.getPassword()); // Assuming txtmatkhau is a JPasswordField

            if ("admin".equals(taiKhoan) && "123".equals(matKhau)) {
                PhongDaoTao phongDaoTaoFrame = new PhongDaoTao();
                phongDaoTaoFrame.setVisible(true);
            } else if ("nhanvien".equals(taiKhoan) && "123".equals(matKhau)) {
                GiangVien gvfrom = new GiangVien();
                gvfrom.setVisible(true);
            } else {
                // Handle unknown role
