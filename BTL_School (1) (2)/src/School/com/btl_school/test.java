...
public class test {
    public static void main(String [] args){
        ...
        ArrayList<Teacher>teachers=teacherDA0.get("31");
        RoomDAO roomDAO=new RoomDAO();
        int ki=1;
        int nam=2024;
        ArrayList<StudentGroup> studentGroups=studentGroupDAO.getList("31",nam,ki);
        CourseDAO courseDAO=new CourseDAO();
        HashMap<String,Course> courses=courseDAO.getList("31");
        ArrayList<Room>rooms=roomDAO.getList("31");
